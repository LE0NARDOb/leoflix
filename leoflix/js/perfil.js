...
function inicializarDados(){
    let dados = JSON.parse(localStorage.getItem("leoflix-users"));
    if(dados === null){
        dados = [
            {
                nome: "leo",
                avatar: "img/users/bojack.jpg",
                crianca: false
            },
            {
                nome: "carol",
                avatar: "img/users/carol.jpg",
                crianca: false
            },
            {
                nome: "vanda",
        ...
        localStorage.setItem("leoflix-users", JSON.stringify(dados));
    }
    perfis = dados;
}
...
function adicionarPerfil(){
    ...
    perfis.push(perfil);
    localStorage.setItem('leoflix-users', JSON.stringify(perfis));
